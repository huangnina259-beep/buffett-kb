...
const LANG = {
    zh: {
        ...
        cardQaCta: '进入问答 →',
        cardTrainTitle: '训练你的思维',
        cardTrainDesc: '通过真实商业案例，学习投资大师的思考方式。',
        cardTrainCta: '浏览案例 →',
    ...
    en: {
        ...
        cardQaCta: 'Enter Q&A →',
        cardTrainTitle: 'Train Your Thinking',
        cardTrainDesc: 'Work through real business cases and learn how investors think.',
        cardTrainCta: 'Browse Cases →',
